...
# Профиль проекта по умолчанию не выводит область. Это не классификация
# элемента как факультативного: см. ГОСТ Р 7.0.100-2018, 4.4.2, 5.10.4, 5.10.8.
# Нормативные основания и ограничения: references/normative-policy.md.
CONTENT_TYPE = False
...
def format(ref: Reference, content_type: bool = False) -> str:
    """content_type=False отключает область в профиле проекта.
    Условно-обязательность элементов определена в 5.10.4 и 5.10.8."""
    global CONTENT_TYPE
